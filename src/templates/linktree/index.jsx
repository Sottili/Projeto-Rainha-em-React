      ...
      <div className="containerLinktree">
        <Row>
          <Col className="col1Linktree" xs={12}>
            <h1 className="titleLinktree">Rainha da Antiga Religião</h1>
            <img src={logo} alt="Logo rainha" />
            ...
            <h2 className="subTitleLinktree">Para Agendamento de Cerimônias com Ayahuasca</h2>
          ...
          <Col className="col2Linktree" xs={12} xxl={12} xl={12} md={12}>
              ...
              <Card.Body>
                ...
                <div className="wrapContents">
                  <a className="btnInfo" href="https://t.me/+eTgvh-zZ56g4ZDcx">
                    <img style={{ width: '25px', verticalAlign: 'middle', marginRight: '5px' }} src={telegramIcon} />
                    Maiores Informações
                  </a>
                </div>
              </Card.Body>
            ...
            <Card className="cardCurses" style={{ width: '19rem' }}>
              ...
              <Card.Body>
                ...
                <Card.Text className="customText">
                  ...
                  enxergavam o mundo. Dessa maneira reconectando-se com a natureza, sua magia, nossa linhagem ancestral
                  e com os ancestrais da antiga religião, vamos compreendendo como acessar as energias, se preparar para
                  manipular magias através de rituais, invocações instrumentos de poder e consagrações.
                </Card.Text>
                <Card.Text>
